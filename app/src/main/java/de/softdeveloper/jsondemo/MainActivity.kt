...
//        val jsonString = br.readText()
        ...
        val users = Gson().fromJson(jsonString, UserList::class.java)
...
//            }
//
//            val user = de.softdeveloper.jsondemo.User(name,job,age,city,hobbys,de.softdeveloper.jsondemo.Phone(PhonePrivate,PhoneOffice,PhoneMobile))
//            userList.add(user)
//        }
